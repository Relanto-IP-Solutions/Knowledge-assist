    ...
    def save_rag_answers(
        ...
        try:
            ...
            if not reuse_single_row:
                ...
                row_at = cur.fetchone()
                answer_type = (str(row_at[0]).strip().lower() if row_at and row_at[0] is not None else "")
                ...
                is_picklist_question = (answer_type in {"picklist", "multi_select"}) or has_picklist_options
                logger.bind(
                    opportunity_id=opportunity_id,
                    question_id=question_id,
                ).info(
                    ...
                    if is_conflict:
                        ...
                        self._execute_step(
                            ...
                            WHERE opportunity_id = %s
                              ...
                              AND answer_id = %s
                            """,
                            (len(conflict_answer_ids), now, opportunity_id, question_id, old_active_answer_id),
